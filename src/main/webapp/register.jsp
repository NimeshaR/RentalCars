	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="register.jsp" class="nav-link">Register Now</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Register Now <i class="ion-ios-arrow-forward"></i></span></p>
 ...
 <form action="emp.php" method="post">
	...
	<div class="input-field">
		...
		<br>	
			<div class="input-field">
            Mobile Number
            <input type="phone"name="mobile" class="form-control" id="mobile" placeholder="0777777777" pattern="[0-9]{10}" required><br/><br/>
		</div>
            ...
            <div class="input-field">
                ...
                <input type="text" placeholder="Enter a user name" name="userName" />
            </div>
