...
<center>
        ...
        <div class="image">
             <img src="images/car3.jpg"></div>
                    <div class="title">
                        <h1>Vehicle </h1>
                        <button><a href="../html/onlinejobs.html">Manage</a></button>  
                    </div>  
        </div>
        ...
        <div class="cards">
            <div class="image">
                 <img src="images/user.jpg"></div>
                        <div class="title">
                            <h1>User</h1>
                            <button><a href="../html/partTime.html">Manage</a></button>  
                        </div>  
            ...
            <div class="cards">
                <div class="image">
                     <img src="images/driver.jpg"></div>
                            <div class="title">
                                <h1>Driver</h1>
                                <button><a href="../html/fullTime.html">Manage</a></button>  
                            </div>  
                ...
                <div class="cards">
                    <div class="image">
                         <img src="images/res1.jpg"></div>
                                <div class="title">
                                    <h1>Reservation</h1>
                                    <button><a href="../html/localJobs.html">Manage</a></button>  
                                </div>  
                    </div>
