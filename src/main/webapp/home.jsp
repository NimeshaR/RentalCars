	  					...
	  					<div class="col-md-4 d-flex align-items-center">
	  						...
	  						<form action="insert" method="post" class="request-form ftco-animate bg-primary">
			    				...
			    				<div class="form-group">
			    					...
			    					<input type="text" name="plocation" class="form-control" placeholder="City, Airport, Station, etc" required>
			    				</div>
			    				<div class="form-group">
			    					<label for="" class="label">Drop-off location</label>
			    					<input type="text" name="dlocation" class="form-control" placeholder="City, Airport, Station, etc" required>
			    				</div>
			    				<div class="d-flex">
